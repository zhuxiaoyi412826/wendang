...
![Cookie原理图.png](http://yanxuan.nosdn.127.net/8f5eee48fdc2afa8f6453144d4352183.png)
...
在实现service方式时要选择HttpServlet  如果选择Servlet就实现不了resp.addCookie()

![image-20250429135327066](C:\Users\DELL\AppData\Roaming\Typora\typora-user-images\image-20250429135327066.png)
...
![Coolie1.png](http://yanxuan.nosdn.127.net/b58828e7d2a5f6d39c7add349014fb1a.png)
...
![读取Cooklie.png](http://yanxuan.nosdn.127.net/cae82496f5f6eea562c886dd89e7c1ec.png)
...
![Cookile时效性.png](http://yanxuan.nosdn.127.net/6097fd834fb6f1e876aaa6c97d5a4b2b.png)
...
![Cookile2.jpg](http://yanxuan.nosdn.127.net/e86721db249f64d53768940125313cd9.jpg)
...
![cookie路径1.png](http://yanxuan.nosdn.127.net/f1fd8fed85feecade717279397bdbf9d.png)

+ 向ServletB请求时携带携带了 c1

 ![cookie路径2.png](http://yanxuan.nosdn.127.net/9a5e2bdbf76a40eb5bcc7db77ee64937.png)

+ 向其他资源请求时就不携带c1了

![cookie路径3.png](http://yanxuan.nosdn.127.net/2f98019c8e8c3b4804cfca6757f9ff0d.png)
...
![session原理图.png](http://yanxuan.nosdn.127.net/99e8eff3b29d939cb9ac9d9ce6518ef7.png)
...
![getsession逻辑图.png](http://yanxuan.nosdn.127.net/b3b755e43dad0a8e97f3a334c0f9d8c1.png)
...
![session闲置时间.png](http://yanxuan.nosdn.127.net/db77cff45c604f69a4977a4f2b6d8ca1.png)

> 我们可以自己在当前项目的web.xml对最大闲置时间进行重新设定

![设置session闲置时间.png](http://yanxuan.nosdn.127.net/ccafb77bcba2da1c68ccbf0af0aaaa42.png)
...
![请求域.png](http://yanxuan.nosdn.127.net/abcd0a977aef7a8ecec9e32e0ae75950.png)

+ 会话域

![会话域.png](http://yanxuan.nosdn.127.net/889c252fbb82377ab0fdeef6ee06c2c7.png)

+ 应用域

![应用域.png](http://yanxuan.nosdn.127.net/e0eacdb39d4af5b59909910051dd50ca.png)

+ 所有域在一起

![域保存.png](http://yanxuan.nosdn.127.net/e9edd5aaae41b67196806744f0138db7.png)
...
![过滤器工作位置.png](http://yanxuan.nosdn.127.net/d5c2f33950b460c4a65ad3c9ed32ad28.png)
...
public class LoggingFilter  implements Filter {
    /**
     * 过滤请求和响应的方法
     * 该方法有能力控制请求是否继续向后到达目标资源，可以在该方法直接向客户端响应处理
...
![过滤器图解.png](http://yanxuan.nosdn.127.net/ac53cecb0251e967f52155f325e9e8f1.png)
...
```xml
 <filter>
        <filter-name>lifeCycleFilter</filter-name>  别名
        <filter-class>com.zxy.filter.filters.LifeCycleFilter</filter-class>  项目路径
        <init-param>
            <param-name>dataTimePattern</param-name>
            <param-value>YYY-MM-DD HH:mm:ss</param-value>
        </init-param>
    </filter>
    <filter-mapping>
...
![过滤器链.png](http://yanxuan.nosdn.127.net/1fb05bb32316581d45e07e005890949b.png)
...
注解
@WebFilter("/*")
过滤器顺序跟类名有关  从小到大如 1-2-3
```

> 工作流程图解

![工作流程图解.png](http://yanxuan.nosdn.127.net/bd37905bf7eaf304d0cc8ccd3157f674.png)
